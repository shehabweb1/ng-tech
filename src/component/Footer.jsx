...
const Footer = () => {
	...
	return (
		<footer className="p-10 bg-base-300 ">
			<div className="footer text-base-content">
				<nav>
					...
					<div className="text-center">
						<p className="flex">
							<HiOfficeBuilding className="text-lg mr-1" /> Mohammadpur,
							Dhaka-1207
						</p>
						<p className="flex my-2">
							<MdLocalPostOffice className="text-lg mr-1" /> contact@ngtech.com
						</p>
						<p className="flex my-2">
							<HiPhone className="text-lg mr-1" /> +8801608451204
						</p>
					</div>
				</nav>
				<nav>
					...
					<div className="grid grid-flow-col gap-4">
						<Link to="https://twitter.com/shehab_web1" target="_blank">
							<svg
						...
						<Link to="https://github.com/shehabweb1" target="_blank">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
								height="24"
						...
						<Link to="https://www.facebook.com/shehab.web" target="_blank">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
								height="24"
			...
			<p className="text-center mt-3">Copyright © 2023 - All right reserved</p>
		</footer>
	);
};
